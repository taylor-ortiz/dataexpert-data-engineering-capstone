...
file_path = f"s3a://{s3_bucket}/tayloro-capstone-data/Colorado_Crimes_2016_2020.csv"
...
spark.sql("""
CREATE TABLE IF NOT EXISTS `eczachly-academy-warehouse`.tayloro.colorado_crimes_2016_2020_raw_new (
...
df.writeTo("`eczachly-academy-warehouse`.tayloro.colorado_crimes_2016_2020_raw_new") \
