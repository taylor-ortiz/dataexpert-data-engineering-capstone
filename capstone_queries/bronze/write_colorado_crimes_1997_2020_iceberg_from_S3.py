...
file_path = f"s3a://{s3_bucket}/tayloro-capstone-data/Colorado_Crimes_1995_2015.csv"
...
spark.sql("""
CREATE TABLE IF NOT EXISTS `eczachly-academy-warehouse`.tayloro.colorado_crimes_1995_2015_raw (
...
df.writeTo("`eczachly-academy-warehouse`.tayloro.colorado_crimes_1995_2015_raw") \
