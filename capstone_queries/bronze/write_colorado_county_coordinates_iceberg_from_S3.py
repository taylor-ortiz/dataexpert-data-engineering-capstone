...
spark.sql("""
CREATE TABLE IF NOT EXISTS `eczachly-academy-warehouse`.tayloro.colorado_counties_coordinates_raw (
    county STRING,
    label STRING,
    cent_lat DOUBLE,
    cent_long DOUBLE
...
df.writeTo("`eczachly-academy-warehouse`.tayloro.colorado_counties_coordinates_raw") \
