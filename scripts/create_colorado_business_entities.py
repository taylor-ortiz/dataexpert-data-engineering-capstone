...
spark.sql("""
CREATE TABLE IF NOT EXISTS `tayloro-academy-warehouse`.tayloro.colorado_business_entities (
    entityid LONG,
    entityname STRING,
    principaladdress1 STRING,
    principaladdress2 STRING,
    principalcity STRING,
    principalcounty STRING,  -- Mapped county from cities dataset
...
USING iceberg
PARTITIONED BY (principalcounty)
""")
